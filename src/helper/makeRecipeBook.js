...
export function makeRecipeBook() {
  ...
  ingredients.set(13, new Ingredient("Olive Oil (Extra-Virgin)", 8, 8.84, 0));
  ...
  ingredients.set(150, new Ingredient("Yeast (Instant)", 2, 3.25, 0));
  ...
  recipes.set(
    6,
    new Recipe("Yeastbread with Poolish", 1, recipeIngredients, includedRecipes)
  );
  ...
  recipes.set(8, new Recipe("Voordeeg", 3, recipeIngredients, includedRecipes));
