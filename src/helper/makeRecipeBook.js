...
export function makeRecipeBook() {
    ...
    ingredients.set(45, new Ingredient('Lemon Juice', 12, .25, 0))
    ...
    ingredients.set(55, new Ingredient('Apples (Baked)', 13, .5, 0))
    ingredients.set(56, new Ingredient('Apricots (Dried)', 13, 2.41, 0))
    ingredients.set(57, new Ingredient('Blueberries (Dried)', 13, 3.25, 0))
    ingredients.set(58, new Ingredient('Cranberries (Dried, Unsweetened)', 13, 0, 0))
    ingredients.set(59, new Ingredient('Cranberries (Dried, Sweetened)', 13, 3.08, 0))
    ...
    ingredients.set(68, new Ingredient('Coconut (Shredded, Unsweetened)', 14, 6.6, 0))
    ...
    ingredients.set(86, new Ingredient('White Granulated Sugar (Fine)', 7, 3.89, 0))
    ingredients.set(87, new Ingredient('Brown Sugar (Light', 7, 3.97, 0))
    ingredients.set(88, new Ingredient('Brown Sugar (Dark)', 7, 3.69, 0))
    ingredients.set(89, new Ingredient('Powdered Sugar (Confectioners)', 7, 3.89, 0))
    ...
    ingredients.set(103, new Ingredient('Baking Ammonia (Ammonium Carbonate)', 5, 0, 0))
    ...
    ingredients.set(128, new Ingredient('Cream (Half & Half, 10-18%)', 3, 1.3, 0))
    ingredients.set(129, new Ingredient('Cream (Light, 18-30%)', 3, 1.95, 0))
    ingredients.set(130, new Ingredient('Cream (Light Whipping, 30-36%)', 3, 3.35, 0))
    ...
    ingredients.set(160, new Ingredient('Chickpea Flour (Gram, Besan)', 1, 3.87, 0))
    ...
    recipeIngredients.push(new RecipeIngredient(false, true, 109, .6))
    recipes.set(1, new Recipe('Sourdough starter', 3, recipeIngredients, includedRecipes))
    ...
    recipes.set(2, new Recipe('100% Poolish', 3, recipeIngredients, includedRecipes))

    recipeIngredients = []
    includedRecipes = []
    recipeIngredients.push(new RecipeIngredient(true, false, 154, 1))
    recipeIngredients.push(new RecipeIngredient(false, true, 109, 0.60))
    ...
    includedRecipes.push(new IncludedRecipe(2, 0.30))
    recipes.set(3, new Recipe('Rustic boule', 1, recipeIngredients, includedRecipes))

    recipeIngredients = []
    includedRecipes = []
    recipeIngredients.push(new RecipeIngredient(true, false, 174, 1))
    recipeIngredients.push(new RecipeIngredient(false, true, 109, 1))
    includedRecipes.push(new IncludedRecipe(1, .10))
    recipes.set(4, new Recipe('Sourdough predough', 3, recipeIngredients, includedRecipes))

    recipeIngredients = []
    includedRecipes = []
    recipeIngredients.push(new RecipeIngredient(true, false, 156, .60))
    recipeIngredients.push(new RecipeIngredient(true, false, 174, .40))
    recipeIngredients.push(new RecipeIngredient(false, true, 109, .65))
    recipeIngredients.push(new RecipeIngredient(false, true, 15, .04))
    recipeIngredients.push(new RecipeIngredient(false, false, 102, .016))
    includedRecipes.push(new IncludedRecipe(4, .10))
    recipes.set(5, new Recipe('Paul\'s wheat-rye bus', 2, recipeIngredients, includedRecipes))
    ...
    recipes.set(6, new Recipe('Yeastbread with Poolish', 1, recipeIngredients, includedRecipes))

    recipeIngredients = []
    includedRecipes = []
    recipeIngredients.push(new RecipeIngredient(true, false, 181, .5))
    ...
    recipes.set(7, new Recipe('Tarwe rogge boekweit volkeren zuurdesem', 2, recipeIngredients, includedRecipes))

    recipeIngredients = []
    includedRecipes = []
    recipeIngredients.push(new RecipeIngredient(true, false, 182, 1))
    recipeIngredients.push(new RecipeIngredient(false, true, 109, 1))
    includedRecipes.push(new IncludedRecipe(9, .10))
