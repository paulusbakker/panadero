        ...
        <>
            <div className="recipes-ingredients-list__item__title">
                ...
                {showEditCategoryPopup &&
                    <div className="recipes-ingredients-list__item__title__popup" ref={ref1}>
                        Edit Category
                    </div>}
            </div>
            <div
                ...
                <div className="backdrop" ref={ref2}>
                    <div className="backdrop__popup">
                        ...
                        <input type="text"
                               ...
                               value={field}
                        />
                        <button className="backdrop__popup__submit" ref={ref3}>Submit</button>
                    </div>
                </div>
            }
        </>
