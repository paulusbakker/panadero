...
import theme from '../../../shared/styles/Theme' // theme needs to be imported because component is lays deeper
...
export const ListItemStyled = styled.li`
    ...
    align-items: center;
    background-color: ${(props) => props.$isFaultyItem ? theme.colors.faultyItem : props.$isOrHasMissingInParent ? theme.colors.isOrHasMissing : theme.colors.contentBackgroundColor};
